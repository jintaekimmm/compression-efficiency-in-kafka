...
func BenchmarkProducerJsonMarshaling(t *testing.B) {
	topicBase := "json-marshaling-only"
...
//go test -bench=^BenchmarkProducerJsonMarshaling$ . -run=^$ -v -timeout 60m
//goos: darwin
//goarch: amd64
//pkg: github.com/99-66/compression-efficiency-in-kafka/bench
//cpu: Intel(R) Core(TM) i7-8569U CPU @ 2.80GHz
//BenchmarkProducerJsonMarshaling
//BenchmarkProducerJsonMarshaling-8              1        391762802039 ns/op
//PASS
//ok      github.com/99-66/compression-efficiency-in-kafka/bench    392.303s
